...
//   const [holdingState, setHoldingText] = useState(false);
...
//   const insertIntoEditor = (text, paste = false) => {
//     const range = reactQuillRef.current.getEditor().getSelection();
//     const position = range ? range.index : 0;
//     if (paste) {
//       reactQuillRef.clipboard.dangerouslyPasteHTML(position, text);
//     } else {
//       reactQuillRef.current.getEditor().insertText(position, text);
//     }
//     setHoldingText(text);
//   };
...
//     setHoldingText(result.response.text());
//     setLoading(false);
//     insertViewContent();
//   };
...
//           <Button onClick={regenerateSuggestion}>Regenerate</Button>
//         </div>
//       </div>
//     );
//   };

//   const insertViewContent = () => {
//     insertIntoEditor(viewNewContent(), true);
//   };
...
//             <Form form={form} onFinish={apiCall}>
//               <Form.Item
//                 name="title"
//                 rules={[
...
//                   addonAfter={<Button htmlType="submit ">AI Suggest</Button>}
//                 />
//               </Form.Item>
//             </Form>
//           </div>
...
//           <Button type="primary" shape="round" onClick={acceptSuggestion}>
//             Accept
//           </Button>
//           <Button type="primary" shape="round" onClick={rejectSuggestion}>
//             Reject
//           </Button>
//           <Button type="primary" shape="round" onClick={regenerateSuggestion}>
//             Regenerate
//           </Button>
//         </div>
